...
'------------------------------------------------------------------'
def langchain_lokha(state, user_query, image, image_process_mode):
    # image_path = '/content/LLaVA-Med/llava/serve/examples/synpic42202.jpg'
    ...
    for question in questions:
        answer = llava_med(state, text=question, image_path=image, image_process_mode=image_process_mode)
